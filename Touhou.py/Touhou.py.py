...
def main():
    ...
    bg = pygame.image.load("assets/image/bg.png").convert_alpha()

    hitsound = pygame.mixer.Sound("assets/audio/hitsound.wav")

    bgm = ["assets/audio/night of nights.mp3", "assets/audio/lunatic eyes invisible full moon.mp3", "assets/audio/voyage 1970.mp3"]
    
    pygame.mixer.init()
    pygame.mixer.music.load(random.choice(bgm))
